...
public class comtradeTest {
    ...
    public void hoverDomaci() {
        ...
        sum = num1 * num2 / num3;
        System.out.println("Ovo je proizvod: " + sum);
        ...
        //js.executeScript("arguments[0].scrollIntoView();",driver.findElement(By.xpath("//strong[contains(text(),\"Beko kombinovani sporet\")]")));
